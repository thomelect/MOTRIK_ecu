...
#define REG_CONFIG0 0x0000   // 0 | 0 | 0 | WR
#define REG_CONFIG1 0x2000   // 0 | 0 | 1 | WR
#define REG_CONFIG2 0x4000   // 0 | 1 | 0 | WR
#define REG_CONFIG3 0x6000   // 0 | 1 | 1 | WR
#define REG_CONFIG4 0x8000   // 1 | 0 | 0 | WR
#define REG_CONFIG5 0xA000   // 1 | 0 | 1 | WR
#define REG_MASK_DIAG 0xC000 // 1 | 1 | 0 | WR
#define REG_RUN 0xE000       // 1 | 1 | 1 | WR
#define REG_DIAG 0xC000      // 1 | 1 | 0 | 0
